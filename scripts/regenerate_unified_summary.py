...
def main() -> int:
    ...
    # Keep this artifact valid RFC-style CSV.  Earlier versions prepended two
    # free-form comment lines, causing standard readers (including pandas with
    # default settings) to infer a two-column schema and fail on the header.
