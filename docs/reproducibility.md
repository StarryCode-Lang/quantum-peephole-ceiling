...
- `environment.yml` — a thin conda entry point (Python 3.12) that installs from `requirements.txt` via `pip: -r requirements.txt`; it intentionally contains no package pins of its own (2026-08-06: the former duplicated pin list was removed).
