> **ARCHIVED (2026-07-21, wave 3)**: This fragment is fully merged into manuscript v8 Section 6.7 (Theory–Experiment Cross-Validation, Table 19) and is retained here for provenance only. Do not edit or re-merge; the canonical location is `docs/manuscript/manuscript.md` §6.7. The former "pending merge" status is obsolete.
